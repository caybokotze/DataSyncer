...
namespace Jessidatasyncer.Mappings
{
    ...
    {
        public DataTable MapToMsSql(DataTable msSqlRecords)
        {
            DataTable mySqlRecords = new DataTable();
            
            //Return mySqlRecords

            mySqlRecords = CreateColumns(ref mySqlRecords);
        ...
        static DataTable CreateColumns(ref DataTable mySqlColumns)
        {
